...
const Newslater = () => {
    return (
        <section className="py-6 border-2 rounded-lg  border-pink-600 dark:bg-violet-600 dark:text-gray-50">
	<div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 md:px-24 xl:px-48">
		...
		<button className="px-8 py-3 font-semibold rounded-full dark:bg-gray-800 dark:text-gray-100">Learn more</button>
	</div>
</section>
    );
};
